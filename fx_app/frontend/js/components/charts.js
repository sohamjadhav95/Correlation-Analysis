...
const Charts = {
    COLORS: {
        get line1() { return getComputedStyle(document.documentElement).getPropertyValue('--accent-purple').trim(); },
        get line2() { return getComputedStyle(document.documentElement).getPropertyValue('--accent-orange').trim(); },
        get spread() { return getComputedStyle(document.documentElement).getPropertyValue('--accent-green').trim(); },
        get flipDot() { return getComputedStyle(document.documentElement).getPropertyValue('--accent-red').trim(); },
        get bar() { return getComputedStyle(document.documentElement).getPropertyValue('--accent-red').trim(); },
        get barBorder() { return getComputedStyle(document.documentElement).getPropertyValue('--accent-red').trim(); }, // Slight simplification for border, could use a darker red if needed
        get baseline() { return getComputedStyle(document.documentElement).getPropertyValue('--text-muted').trim(); },
        get grid() { return getComputedStyle(document.documentElement).getPropertyValue('--border-default').trim(); },
        get axis() { return getComputedStyle(document.documentElement).getPropertyValue('--text-muted').trim(); },
        get text() { return getComputedStyle(document.documentElement).getPropertyValue('--text-secondary').trim(); },
        bg: 'transparent',
        get fillPos() { return getComputedStyle(document.documentElement).getPropertyValue('--accent-green-dim').trim(); },
        get fillNeg() { return getComputedStyle(document.documentElement).getPropertyValue('--accent-red-dim').trim(); },
    },
