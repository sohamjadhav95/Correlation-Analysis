"""
Absolute Flip — Live MT5 Trading Script
========================================
...
Position structure (hedge mode, always 2 open tickets):
...
LOT_1    = 0.01         # Lot size for SYMBOL_1
LOT_2    = 0.00        # Lot size for SYMBOL_2
...
LOG_FILE  = "absolute_flip_live.log"  # Set to "" to disable file logging
...
def run_live() -> None:
    ...
    def execute_flip(new_pos: str) -> None:
        ...
        logger.info(
            f"Positions active | "
            f"{SYMBOL_1} ticket={pos1_ticket} {pos1_type} | "
            f"{SYMBOL_2} ticket={pos2_ticket} {pos2_type}"
        )
    ...
    logger.info("=" * 60)
    logger.info("Absolute Flip Live — Started")
    ...
    while True:
        ...
        try:
            ...
            # SM sets cur_pos but returns None on init tick (no flip signal)
